  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-mithai-off px-4 py-12">
      <div className="w-full max-w-md rounded-[2rem] bg-white/95 p-10 shadow-[0_30px_60px_rgba(0,0,0,0.12)]">
        <h1 className="text-3xl font-semibold text-mithai-charcoal">Create account</h1>
        <p className="mt-3 text-sm text-slate-500">Join Mithai 2.0 to order clean, sugar-free sweets and snacks.</p>
        ...
        <p className="mt-6 text-center text-sm text-slate-500">
          ...
          <Link href="/login" className="font-semibold text-mithai-charcoal hover:text-mithai-pink">
            Sign in
          </Link>
        </p>
      </div>
